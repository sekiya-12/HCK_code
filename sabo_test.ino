...
const uint16_t BPM_LOCK_MS = 200;
...
void setup() {
  ...
  // 使い方の説明を表示
  Serial.println("=== BPM Manual Control Mode ===");
  Serial.println("Enter BPM value (40-255) in the Serial Monitor and press Enter.");
